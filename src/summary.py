...
4. No generalices ni dramatices un titular más allá de lo que dice. Un conflicto, guerra, tensión o sanciones entre países es de los países o bandos implicados, no de una sola persona: escribe "la guerra entre Estados Unidos e Irán", nunca "la guerra de [una persona] con [país]", salvo que el propio titular use exactamente esa construcción. La misma norma aplica a decisiones institucionales (un banco central, un gobierno, un organismo): no se las atribuyas a una sola persona salvo que el titular lo haga explícitamente.
...
6. En "Cómo llegamos" repasa TODOS los activos de la tabla MERCADO, aunque sea en una frase breve para los que apenas se han movido; no te centres solo en los que más subieron o bajaron. Agrupa los que se muevan por motivos parecidos.
7. En "Qué vigilar esta semana" incluye TODOS los titulares que anticipen algo que vaya a pasar (una reunión, una decisión, una fecha, unos datos que se publiquen próximamente), no solo el primero que encuentres. Si ningún titular anticipa algo así, dilo explícitamente en vez de rellenar con noticias ya ocurridas.
8. En "Riesgos" incluye solo factores que sean una amenaza real para los mercados, la economía o tus activos (volatilidad, caídas, tensiones que puedan escalar, subidas de tipos, aranceles). Un anuncio administrativo o institucional neutro (por ejemplo, que un banco central ajuste un procedimiento interno o invierta en un proyecto propio) NO es un riesgo por sí mismo y no debe aparecer aquí salvo que el titular explique por qué amenaza al mercado.
